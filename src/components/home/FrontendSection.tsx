      ...
      <style>{`
        ...
        */
        @media (max-width: 680px) {
          ...
          .frontend-mobile-hidden-repository {
        ...
        */
        .frontend-project-details-link-label-compact {
          display: none;
        }

        @media (min-width: 1181px) and (max-height: 1050px) {
          .frontend-project-detail-outcome .frontend-compact-phone-detail-value {
            display: block;
            max-height: calc(3 * 1lh);
            overflow: hidden;
          }

          .frontend-project-details-link-label-default {
            display: none;
          }
        ...
        @media (min-width: 1181px) and (max-height: 720px) {
          .frontend-project-detail-outcome {
            display: none !important;
          }
        }
        ...
        >
          <div ref={contentRef} className="relative h-full w-full">
                            ...
                            <div className="frontend-desktop-copy-distribution frontend-browser-zoom-compensated flex w-full flex-col items-end">
                              ...
                              {(project.liveUrl ||
                                ...
                                <div className="frontend-desktop-links frontend-project-copy frontend-compact-phone-links ml-auto mt-[clamp(1.05rem,1.6vh,1.4rem)] flex w-full max-w-[23rem] flex-wrap items-center font-bold justify-end gap-x-[clamp(1.2rem,1.8vw,1.95rem)] gap-y-3 max-[1180px]:mt-[0.78rem] max-[1180px]:max-w-[31rem] max-[1180px]:gap-x-3 max-[1180px]:gap-y-2 min-[901px]:max-[1180px]:mt-[0.5rem] min-[901px]:max-[1180px]:gap-x-2.5 min-[901px]:max-[1180px]:gap-y-1.5 max-[680px]:mt-[0.82rem] max-[680px]:max-w-none">
                                  ...
                                  {project.repositoryUrl ? (
                                    <a
                                      className="frontend-project-link frontend-compact-phone-action frontend-mobile-hidden-repository pointer-events-auto inline-flex items-center justify-center gap-[clamp(0.42rem,0.52vw,0.58rem)] rounded-full border border-[#171717]/11 bg-white/[0.045] px-[clamp(1.05rem,1.22vw,1.3rem)] py-[clamp(0.6rem,0.72vw,0.76rem)] font-mono text-[clamp(0.68rem,0.76vw,0.84rem)] uppercase tracking-[0.12em] text-[#171717]/62 backdrop-blur-[8px] transition-[transform,background-color,opacity] duration-200 hover:-translate-y-px hover:bg-white/16 hover:opacity-75 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#171717]/14 max-[1180px]:gap-[0.38rem] max-[1180px]:px-[0.92rem] max-[1180px]:py-[0.58rem] max-[1180px]:text-[0.62rem] min-[901px]:max-[1180px]:px-[0.84rem] min-[901px]:max-[1180px]:py-[0.5rem] min-[901px]:max-[1180px]:text-[0.58rem] max-[680px]:text-[0.6rem]"
                                  ...
                                  {project.detailsSlug ? (
                                    ...
                                    >
                                      <span className="frontend-project-details-link-label-default">
                                        View project →
                                      </span>
                                      <span className="frontend-project-details-link-label-compact">
                                        Read more →
                                      </span>
                                    </Link>
                                  ) : null}
            ...
            <div
              ...
              className="pointer-events-auto w-[11px] h-full absolute right-[2.1vw] top-0 z-[65]"
            >
              <div
                aria-hidden="true"
