...
export default function BackendSection({
  ...
  useEffect(() => {
    ...
    const syncTimelineRailGeometry = () => {
      ...
      frame = requestAnimationFrame(() => {
        ...
        section.style.setProperty(
          "--backend-horizontal-nav-reserve",
    ...
    return () => {
      ...
      section.style.removeProperty("--backend-horizontal-nav-reserve");
    };
  }, []);
    ...
    >
      <style>{`
        /*
          ...
          responsive CSS is correct. The existing "backend-browser-zoom-compensated"
        ...
        */
        @media (max-width: 1180px) {
          .backend-compact-phone-composition {
            bottom: calc(
              var(--backend-horizontal-nav-reserve, 3.5rem) +
