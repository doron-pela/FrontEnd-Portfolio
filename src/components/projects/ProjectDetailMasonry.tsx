...
export default function ProjectDetailMasonry({
  ...
  return (
    <section
      ...
      className="mt-0"
    >
      <div className="mb-[clamp(1.5rem,3vw,2.8rem)] flex items-end justify-between gap-6 border-b border-white/12 pb-4">
        <div>
          <p className="font-mono text-[clamp(0.58rem,0.66vw,0.72rem)] font-semibold uppercase tracking-[0.16em] text-white/42">
            Project gallery
          </p>
      ...
      */}
      <div className="columns-1 gap-[clamp(0.9rem,1.6vw,1.5rem)] min-[760px]:columns-2">
        {renderableScreenshots.map((screenshot, index) => (
          ...
          >
            <div className="relative overflow-hidden rounded-[clamp(0.78rem,1.3vw,1.35rem)] bg-white/[0.035]">
              <img
                alt={screenshot.alt}
              ...
              <span className="pointer-events-none absolute left-3 top-3 rounded-full border border-white/58 bg-white/62 px-2.5 py-1 font-mono text-[0.52rem] font-semibold tracking-[0.12em] text-white/58 backdrop-blur-[12px]">
